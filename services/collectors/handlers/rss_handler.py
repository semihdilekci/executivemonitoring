...
RSS_SOURCE_TYPE = SourceType.RSS.value


def lambda_handler(event: dict[str, Any], context: Any) -> dict[str, Any]:
    """EventBridge → RSS collector Lambda giriş noktası."""
    import asyncio
    ...
    async def _run() -> dict[str, int]:
        sources = await sources_loader(RSS_SOURCE_TYPE)
        return await run_collector_batch(RSS_SOURCE_TYPE, sources)
