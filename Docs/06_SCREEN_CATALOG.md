...
| **admin** | Sol `Sidebar` (mockup referansı) | Ana Menü: Ana Sayfa, Bültenler, AI Chatbot · Yönetim: Kullanıcılar, Kaynaklar, Pipeline İzleme, İçerik Arşivi, Prompt Şablonları, API Yönetimi, Bildirimler, Sohbet Geçmişi, Denetim Logu · Altta avatar + rol |
...
| Schema | Dropdown: Tümü / news / market / geo / fmcg / transport | `schema_category` |
...
| Kategori | 120px | `content_category` label + `schema_category` küçük badge |
